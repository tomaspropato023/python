...
def iniciar_cuestionario(ventana):
    ...
    puntaje = tk.IntVar(value=0)  # Inicializar el puntaje
...
def mostrar_resultados():
    ...
    resultado_texto = f"Tu conocimiento actual sobre ESI es de {puntaje.get() * 100 / 10:.2f}% basado en este cuestionario."
